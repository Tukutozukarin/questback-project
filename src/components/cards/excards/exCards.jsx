                    ...
                    datasets: [
                        {
                            label: 'The Impact',
                            data: [
                                Math.round((state.CostPerHireValues * (((state.SizeValue / 100) * state.GrowValue) + ((state.SizeValue / 100) * state.AttritionValue))) +
                                    ((state.PayValue / state.FullProductionCost) * state.OnboardingTimeValue * (((state.SizeValue / 100) * state.GrowValue) + ((state.SizeValue / 100) * state.AttritionValue))) +
                    ...
                    datasets: [
                        {
                            ...
                            data: [
                                ...
                                ((state.PayValue / 240) * state.OnboardingTimeValue * (((state.SizeValue / 100) * state.GrowValue) + ((state.SizeValue / 100) * state.AttritionValue))) -
        ...
        <div>
            ...
            <div className="container-fluid nav-sidebar">
                <ul className="list-sidebar">
                    ...
                    <p></p>
                    <li className="div-link-text-sidebar" onClick={() => { this.handleScrollTo(this.refAboutYourCompany) }}>About your company</li>
                    ...
                    <p></p>
                    <li className="div-link-text-sidebar" onClick={() => { this.handleScrollTo(this.refUsingQuestback) }}>Using Questback</li>
                    <p></p>
            ...
            <div className="bg-content mt-4 mb-4" ref={this.refROIDashboard}>
                <div className="container d-flex justify-content-between">
                    ...
                    <p className="sum">{this.state.currencyChange} {Math.round((this.state.PayValue * ((this.state.SizeValue / 100) * this.state.AttritionValue))) -
                        ((this.state.PayValue) * ((this.state.SizeValue / 100) * this.state.CalculationAttritionValue)) +
                        ((this.state.PayValue / 240) * this.state.OnboardingTimeValue * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))) -
                        ((this.state.PayValue / this.state.FullProductionCost) *
                            (this.state.CalculationOnboardingValue) *
                            (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))) +
                        (this.state.CostPerHireValues * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))) -
                        (this.state.CalculationCPHValue * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue)))
                    ...
                    <div className=" col-xs-12 col-lg-5">
                        <div className="card shadow">
                            <div className="card-body">
                                <h4 className="card-title"><b>THE IMPACT</b></h4>

                                <div className="div-the-impact-card-info">
                                    <p className="the-impact-total-new-hires-text"><b>Total New Hires >> </b></p>
                                    <b className="the-impact-total-new-hires-number p-TheImpact-GreenValue">{Math.round(((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))}</b>
                                    <hr className="hr-total-new-hires" />

                                    <p className="the-impact-cost-of-recruitmet-text"><b>Cost of Recruitment</b></p>
                                    <b className="the-impact-cost-of-recruitmet-number p-TheImpact-GreenValue">{this.state.currencyChange} {Math.round(this.state.CostPerHireValues * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue)))}</b>

                                    <p className="the-impact-productivity-cost-text"><b>Cost of Onboarding</b></p>
                                    <b className="the-impact-productivity-cost-number p-TheImpact-GreenValue">{this.state.currencyChange} {Math.round((this.state.PayValue / 240) * this.state.OnboardingTimeValue * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue)))} </b>

                                    <p className="the-impact-cost-of-attrition-text"><b>Cost of Attrition</b></p>
                                    <b className="the-impact-cost-of-attrition-number p-TheImpact-GreenValue">{this.state.currencyChange} {Math.round(this.state.PayValue * ((this.state.SizeValue / 100) * this.state.AttritionValue))}</b>
                                    ...
                                    <b className="the-impact-total-cost-number p-TheImpact-GreenValue">
                                        {this.state.currencyChange} {Math.round(
                                            (this.state.CostPerHireValues * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))) +
                                            ((this.state.PayValue / this.state.FullProductionCost) * this.state.OnboardingTimeValue * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue))) +
            ...
            <div className="container mt-5 mb-5">
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <div className="col-md-2 text-right">
                            <h4 className="p-DoTheCalculation-GreenValue">
                                {this.state.currencyChange}{Math.round(this.state.CalculationCPHValue * (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue)))}
                            </h4>
                        </div>
                    </div>
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <div className="col-md-2 text-right">
                            <h4 className="p-DoTheCalculation-GreenValue">
                                ...
                                {Math.round((this.state.PayValue / this.state.FullProductionCost) *
                                    (this.state.CalculationOnboardingValue) *
                                    (((this.state.SizeValue / 100) * this.state.GrowValue) + ((this.state.SizeValue / 100) * this.state.AttritionValue)))}
                            </h4>
                        </div>
                ...
                <div className="container-fluid bg-content p-4 mt-3 mb-3">
                    ...
                    <div className="row align-items-center mb-3">
                        ...
                        <div className="col-sm-12 col-md-2 text-right">
                            <h4 className="p-DoTheCalculation-GreenValue">
                                {this.state.currencyChange}{Math.round((this.state.PayValue) * ((this.state.SizeValue / 100) * this.state.CalculationAttritionValue))}
                            </h4>
                        </div>
                    </div>
